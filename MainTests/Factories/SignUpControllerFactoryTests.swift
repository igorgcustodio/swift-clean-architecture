...
class SignUpControllerFactoryTests: XCTestCase {
    ...
    func test_signUp_compose_with_correct_validations() {
        ...
        XCTAssertEqual(validations[5] as! CompareFieldsValidation, CompareFieldsValidation(fieldName: "password", fieldNameToCompare: "passwordConfirmation", fieldLabel: "Senha"))
    }
}
